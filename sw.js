const CACHE='trading-diary-v1';
const ASSETS=['./','./index.html','./style.css','./js/data.js','./js/storage.js','./js/statistics.js','./js/charts.js','./js/settings.js','./js/app.js','./manifest.json','./assets/logo.svg'];
